...
- You MUST use your TodoWrite tool to keep track of what you're doing. If unavailable, use your context window.
- You MUST NEVER discard tasks from your TodoWrite/context window todo list without Ben's explicit approval
